...
•	Integrated inside Sitecore Portal (SaaS): Through extension points, the app integrates into the Sitecore UI (for example, as a Dashboard Widget or Page Builder Panel). Currently, it supports only Sitecore AI (formerly XM Cloud), but future updates may include other Sitecore SaaS products. \[https://doc.sitecore.com/mp/en/developers/marketplace/extension-points.html]
o	Standalone: The app appears on the Sitecore Cloud Portal’s home page and opens in a new tab. https://doc.sitecore.com/mp/en/developers/marketplace/extension-points.html#standalone
o	Full screen: The app is listed in the SitecoreAI/XM Cloud navigation bar and displays full-screen under the header — ideal for deep workflows.
https://doc.sitecore.com/mp/en/developers/marketplace/extension-points.html#full-screen
o	Page builder context panel (SitecoreAI/XMC): The app shows up as a panel next to the canvas in Page Builder, perfect for page-specific tools. https://doc.sitecore.com/mp/en/developers/marketplace/extension-points.html#page-builder-context-panel
o	Page builder custom field (SitecoreAI/XMC):: The app is triggered by a custom field in Page Builder, popping up in a modal to provide specialized data or controls. https://doc.sitecore.com/mp/en/developers/marketplace/extension-points.html#page-builder-custom-field
o	Dashboard widget: The app can be added to an SitecoreAI / XM Cloud dashboard to display metrics or insights across the site. https://doc.sitecore.com/mp/en/developers/marketplace/extension-points.html#dashboard-widget 
...
•	Sitecore Marketplace SDK support:
Sitecore is officially offering SDK to build custom sitecore marketplace apps. You can refer the official documentation \[Sitecore Marketplace SDK for JavaScript | Sitecore Documentation], this provides an overview of the SDK, its modules, and how developers can start using it. The SDK’s repository link is here for the reference \[marketplace-sdk/docs/README.md at main · Sitecore/marketplace-sdk · GitHub].
