...
metaDescription: "This article is the third post on creating a Submit Action to save Contacts into the List Manager in Sitecore. In the previous post, we developed the SPEAK…"
keywords: "Sitecore, Sitecore Forms, List Manager, Submit Action, Field Mapping, xConnect"
featuredImage: /uploads/forms-list-map2-Form-Submit-Action-Save-To-Contact-List-With-Field-Mapping.gif
slug: submit-action-to-save-contacts-in-list-manager-with-fields-mapping-part-2
date: June 2, 2023 5:03 AM
author: "Ravindra Mishra"
originalUrl: "https://blogs-archive.perficient.com/2023/06/02/submit-action-to-save-contacts-in-list-manager-with-fields-mapping-part-2/"
source: "Perficient Blogs Archive"
tags:
  - tag: sitecore
---
This article is the third post on creating a **Submit Action to save Contacts into the List Manager in Sitecore**. In the [previous post](/blogs/submit-action-to-save-contacts-in-list-manager-with-fields-mapping-part-1), we developed the SPEAK editor layout for the custom Submit Action in the Core database for Submit Action to have **Field mapping ability**. In this part, we will construct a class to save contact list details in List Manager (Sitecore). We will also create a Submit action item in the master database and associate it with the SPEAK editor item we created in the previous article.
...
![](/uploads/forms-list-map2-Save-To-Contact-List-Submit-Action-Item-1024x322.png)
...
![](/uploads/forms-list-map2-Create-Empty-Contact-List.gif)
...
![](/uploads/forms-list-map2-Form-Submit-Action-Save-To-Contact-List-With-Field-Mapping.gif)
...
![](/uploads/forms-list-map2-Form-Submission-and-Result-Verification.gif)
...
In the [first blog](/blogs/submit-action-to-save-contacts-in-list-manager-basic-implementation), we explored the basic implementation process, which only allows us to save contacts to a specific Contact List.

In the [second blog](/blogs/submit-action-to-save-contacts-in-list-manager-with-fields-mapping-part-1), we focused on creating a SPEAK editor to support field mapping, offering insights into customizing the user interface. Finally, in this third blog, we covered the creation of a submit action item and its backend logic that supports field mapping ability.
