...
description: "A custom submit action for Sitecore forms that will save contact information to the list manager's contact list."
metaDescription: "A custom submit action for Sitecore forms that will save contact information to the list manager's contact list."
keywords: "Sitecore, Sitecore Forms, List Manager, Submit Action, xConnect, Contact List"
featuredImage: /uploads/forms-list-basic-FormSubmitAction-SaveToContactList-2-1.gif
slug: submit-action-to-save-contacts-in-list-manager-basic-implementation
date: May 13, 2023 5:30 AM
author: "Ravindra Mishra"
originalUrl: "https://blogs-archive.perficient.com/2023/05/13/submit-action-to-save-contacts-in-list-manager-basic-implementation/"
...
*Using Save Contacts To Contact List Custom Submit Action in Sitecore Form Editor*
...
![](/uploads/forms-list-basic-Editor-Layout-for-submit-action-1024x336.png)

*Editor Layout For Submit Action*
...
![](/uploads/forms-list-basic-SaveToContactList-EditorLayoutFieldsUpdate-1024x500.png)

*Editor Layout Fields Update - Save To Contact List*
...
![](/uploads/forms-list-basic-SaveToContactList-SubmitActionItem-1024x323.png)

*Parameters field- Save To Contact List Item*
...
![](/uploads/forms-list-basic-Save-To-Contact-List-Submit-Action-Item-1024x322.png)
...
But, the form designers have some restrictions here because they are forced to use the same field name in forms we hardcoded in the code. In the [next post](/blogs/submit-action-to-save-contacts-in-list-manager-with-fields-mapping-part-1), we'll look at adjusting it for form designers, allowing them to choose any field name they want and map it to contact parameters. Stay tuned for the forthcoming post.
