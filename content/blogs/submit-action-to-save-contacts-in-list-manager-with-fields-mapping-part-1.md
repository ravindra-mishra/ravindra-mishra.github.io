...
metaDescription: "This article is the second post in the series on creating a submit action to save contacts into the list manager in Sitecore. In the previous post, we saw a…"
keywords: "Sitecore, Sitecore Forms, SPEAK, Submit Action, Field Mapping, List Manager"
featuredImage: /uploads/forms-list-map1-Form-Submit-Action-Save-To-Contact-List-With-Field-Mapping.gif
slug: submit-action-to-save-contacts-in-list-manager-with-fields-mapping-part-1
date: June 1, 2023 2:11 AM
author: "Ravindra Mishra"
originalUrl: "https://blogs-archive.perficient.com/2023/06/01/submit-action-to-save-contacts-in-list-manager-with-fields-mapping-part-1/"
source: "Perficient Blogs Archive"
tags:
  - tag: sitecore
---
This article is the second post in the series on creating a submit action to save contacts into the list manager in Sitecore. In the [previous post](/blogs/submit-action-to-save-contacts-in-list-manager-basic-implementation), we saw a basic implementation without the ability to map form fields with the custom-created submit action. It only offered the option of configuring the Contact List via the Item Tree View field.
...
![](/uploads/forms-list-map1-Form-Submit-Action-Save-To-Contact-List-With-Field-Mapping.gif)
...
![](/uploads/forms-list-map1-Sitecore-Rocks-connection-500x268.png)
...
*Item Creation And Layout Configuration*
...
*Page Settings and Form Parameters*
...
*Update Form Parameter Folder Id In Layout*
...
![](/uploads/forms-list-map1-SaveToContactList-Javascript-in-project-500x445.png)

*SaveToContactList Javascript In Project*
...
In the [next post](/blogs/submit-action-to-save-contacts-in-list-manager-with-fields-mapping-part-2) of this tutorial, we will go through the ***final steps for creating a submit action item and associated code***.
