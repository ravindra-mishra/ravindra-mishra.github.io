...
slug: sitecore-marketplace-app-nextjs-shadcn-fullstack-guide-part-3
...
---
In the previous part, we configured the app and ran it locally. In this next step, we will authorize the app and validate its authentication flow. We will also test the app using both extension points: *Standalone* and *Page Builder Panel*.
